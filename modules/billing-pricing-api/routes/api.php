...
Route::middleware(['api', 'auth:sanctum', 'ability:billing.pricing.read'])->prefix('api/v1/billing/pricing')->name('billing.pricing.')->group(function (): void {
...
Route::middleware(['api', 'auth:sanctum', 'ability:billing.pricing.write'])->prefix('api/v1/billing/pricing')->name('billing.pricing.')->group(function (): void {
