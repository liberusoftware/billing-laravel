...
final class PortalRequestPolicy
{
    ...
    public function view(?Authenticatable $user, PortalRequest $record): bool
    {
        return $this->access($user, 'read') && $this->owns($user, $record->team_id);
    }

    public function update(?Authenticatable $user, PortalRequest $record): bool
    {
