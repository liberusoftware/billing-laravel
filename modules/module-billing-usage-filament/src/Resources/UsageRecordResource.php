...
final class UsageRecordResource extends Resource
{
    ...
    {
        return $schema->components([TextInput::make('meter_id')->required()->integer()->minValue(1), TextInput::make('event_key')->required()->maxLength(255), TextInput::make('customer_id')->integer()->minValue(1), TextInput::make('quantity')->required()->numeric()->gt(0)]);
    }
