...
final class UsageRecordResource extends Resource
{
    ...
    {
        return $table->columns([TextColumn::make('meter_id'), TextColumn::make('event_key')->searchable(), TextColumn::make('quantity'), TextColumn::make('amount_minor'), TextColumn::make('occurred_at')->dateTime()]);
    }
}
