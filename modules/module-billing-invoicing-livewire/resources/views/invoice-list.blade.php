<div>
    ...
    <form wire:submit="applyLateFee"><input type="number" wire:model="selectedInvoiceId" placeholder="{{ __('Invoice ID') }}"><input type="number" min="1" wire:model="lateFeeMinor" placeholder="{{ __('Late fee') }}"><button type="submit">{{ __('Apply late fee') }}</button></form>
